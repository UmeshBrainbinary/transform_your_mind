...
class _BookmarkScreenState extends State<BookmarkScreen> {
  ...
  @override
  void initState() {
    homeController.getBookMarkedList();
      ...
      body: Stack(
        children: [
          Expanded(
            ...
            builder: (controller) {
              return Expanded(
                child: (controller.bookmarkedModel.data ?? []).isNotEmpty
                    ? Padding(
                                  ...
                                  if (!controller
                                    ...
                                    _onTileClick(
                                      ...
                                      audioContent: AudioData(
                                        ...
                                        isPaid: controller.bookmarkedModel
                                            .data![index].isPaid,
                                        image: controller
                                            .bookmarkedModel.data![index].image,
                                        rating: controller.bookmarkedModel
                                            .data![index].rating,
                                        ...
                                        isRecommended: controller
                                            ...
                                            .data![index]
                                            .isRecommended,
                                        status: controller.bookmarkedModel
                                            .data![index].status,
