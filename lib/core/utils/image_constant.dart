class ImageConstant {
  ...
  static String audioPath1 = 'assets/audio/1.mp3';
  static String audioPath2 = 'assets/audio/2.mp3';
 ...
 static String calendar = '$iconPath/calendar.svg';
  ...
  static String rippleEffect = "$lottie/rippleEffect.json";
  static String rippleE = "$lottie/ripplee.json";
  ...
  static String themeChange = "$iconPath/theme_change.png";
